...
<!-- top part -->
   <div style="display: flex; justify-content:space-between;">
       ...
       <div style="margin-right: auto;">
              <img src="paypal.png" alt="paypal.png" width="120px" >

           <h4 style="font-size: 20px;color:#3d3d3d;">Jhon Doe</h4>
           <p style="margin-top:-20px;font-size: 14px; color: #202020;">8 Elm Street
           <span style="display: block;">Cambridge, CB1 4DH</span>
           <span style="display: block;">United Kingdom</span>
           </p>

           <p style="font-size: 14px; color: #202020;">
            <span style="display: block;">Phone: xxx-xxx-xxx</span>
            Jhondoe@email.com
            </p>
       </div>
       <div style="margin-left: auto;">
           ...
           <p><span style="width: 160px;display: inline-block;background:#bbdefc83;color: #646464;padding: 2px 10px;margin-right: 10px; font-weight: 600;">Invoice Date </span> 06/08/2022</p>
           <p><span style="width: 160px;display: inline-block;background:#bbdefc83;color: #646464;padding: 2px 10px;margin-right: 10px; font-weight: 600;">Payment Terms </span> Due on receipt</p>
           <p><span style="width: 160px;display: inline-block;background:#bbdefc83;color: #646464;padding: 2px 10px;margin-right: 10px; font-weight: 600;">Due Date </span> 06/08/2022</p>
...
<div>
    ...
    <p  style="margin-top:-20px; font-size: 16px; color: #3d3d3d; margin-bottom: 15px;">Jhondoe@email.com</p>
</div>
