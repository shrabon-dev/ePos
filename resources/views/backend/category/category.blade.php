    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Category Add & Lists</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <table class="table mb-0 table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal{{ $category->id }}" style="display:inline-flex;width: 30px; height:30px; box-shadow: 0 0  3px 0 #00000045;font-size:16px; justify-content:center;align-items:center; " title="edit" ><i class="lni lni-pencil"></i></a>
                ...
                <div class="col">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="exampleVerticallycenteredModal{{ $category->id }}" tabindex="-1" style="display: none;" aria-hidden="true">
                                        ...
                                        <div class="p-4 border rounded">
                                            <form action="{{ route('category.update', $category->id) }}" method="post">
                                                ...
                                                <div class="col-md-12 pb-2">
                                                    <label for="validationCustom01" class="form-label">Category name</label>
                                                    <input type="text" class="form-control" id="validationCustom01" name="name" value="{{ $category->name }}" placeholder="name here..." required="">
                                                </div>
                                                <div class="col-md-12 pb-2">
                                                    <label for="validationCustom01" class="form-label">Category slug</label>
                                                    <input type="text" class="form-control" id="validationCustom01" name="slug" value="{{ $category->slug }}" placeholder="slug here..." >
                                                </div>
                                                <div class="col-md-12 pb-2">
                                                    <label for="validationCustom04" class="form-label">Status</label>
                                                    <select class="form-select" id="validationCustom04" name="status" required="">
                                                       ...
                                                       <option @if ($category->status == 'deactive')
                                                        selected
