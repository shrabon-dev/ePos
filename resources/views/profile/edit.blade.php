								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											{{-- <img src="{{ asset('backend_assets') }}/images/avatars/avatar-2.png" alt="Admin" class="rounded-circle p-1 bg-primary" width="110"> --}}
										...
										<div class="card">
											<div class="card-body">
                                                ...
                                                <div class="alert alert-danger mt-4" role="alert">
                                                    <p class="m-0">Once your account is deleted, all of its resources and data will be permanently deleted. Please enter your password
                                                         to confirm you would like to permanently delete your account.</p> </div>
                                                </form>
											</div>
										</div>
									</div>
